...
```{r}
targets <- read_csv("studydesign.csv")

counts <- read_csv("Data.csv")
...
C2CP <- read.gmt("c2.all.v2023.2.Hs.symbols.gmt")
C2CP <- read.gmt("C:\\Users\\derek\\OneDrive - BYU-Idaho\\Documents\\Bio 382\\Bio 382 Explorations\\HHT\\c2.all.v2023.2.Hs.symbols.gmt")
...
C2CP <- getGmt("C:\\Users\\derek\\OneDrive - BYU-Idaho\\Documents\\Bio 382\\Bio 382 Explorations\\HHT\\c2.all.v2023.2.Hs.symbols.gmt", geneIdType=SymbolIdentifier())
